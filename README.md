...
- **weather_search**: This provides a user the ability to search for a city whose weather they are interested in and save it for the weather display app to display.
    - Start this with `pnpm dev:search`
- **weather_display**: This will display blocks of each city the user has saved that will contain the weather information.
